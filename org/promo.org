...
* Matematikk og programmering                                                       :noexport:
** Programmering
...
#+BEGIN_SRC ipython :exports both :results raw
a = 5
b = 3
svar = 0
...
#+BEGIN_SRC ipython :exports both :results output raw
3.2 42.3
#+END_SRC
...
#+BEGIN_SRC ipython :session None
import numpy as np
...
#+BEGIN_SRC ipython :session kloss :exports code
  class Kloss(object):
...
#+BEGIN_SRC ipython :session kloss :exports both
...
#+BEGIN_SRC ipython :session kloss_b
  class Kloss(object):
      """En kloss som glir på et underlag og kan kollidere med andre klosser
      Klosser initieres med en masse, startposisjon og startfart, alle flyttall.
      """
...
#+BEGIN_SRC ipython :exports both :session none
...
#+BEGIN_SRC ipython :exports results :session none
...
#+BEGIN_SRC ipython :session none :exports results
import sys
a, b = 0, 1
...
#+BEGIN_SRC ipython :results silent :session linjeplot
import matplotlib
import matplotlib.pyplot as plt
import numpy as np
#+END_SRC
...
fig, ax = plt.subplots()
ax.plot(x, y)
fig.savefig("enkel_parabel.png")
#+END_SRC

[[fig:enkel_parabel.png]]
