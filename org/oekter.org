...
- [[pdf:42_innlevering.pdf][Innleveringsoppgaver]]

** Innleveringsoppgaver uke 42 :pdf:
:properties:
:export_file_name: ../pdf/42_innlevering.pdf
:end:
*** Tester :noexport:
...
- [[pdf:39_innlevering.pdf][Innleveringsoppgaver]]
- [[pdf:39_repetisjon.pdf][Repetisjonsoppgaver]]
- [[pdf:39_innlevering_alternativ.pdf][Alternative innleveringsoppgaver]] (mer krevende)

** Repetisjonsoppgaver uke 39 :noexport:
:properties:
:export_file_name: ../pdf/39_repetisjon.pdf
:end:
...
:properties:
:export_file_name: ../pdf/39_innlevering.pdf
:end:
...
:properties:
:export_file_name: ../pdf/39_innlevering_alternativ.pdf
:end:
